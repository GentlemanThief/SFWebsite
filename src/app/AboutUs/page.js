...
export default function AboutUs() {
  return (
    <div id="about us" class="bg-base-200">
      ...
      <article class="pt-3">
        <div className="grid items-center grid-cols-1 md:grid-cols-2 bg-base-100 border-y">
          <div className="order-2 md:order-1 md:h-full">
            <AboutUsCarousel class="order-1" />
          </div>
          <div className="order-1 w-full mx-auto md:w-3/4 md:px-0 p-3 order-2">
            <h1 class="text-6xl flex justify-center font-black text-base-content"></h1>
            <h2 class="text-sm sm:text-lg md:text-xs lg:text-sm xl:text-xl text-base-content">
