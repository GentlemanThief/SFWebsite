            ...
            <li>
              <a href="https://twitter.com/teamstrike1st?lang=en" target="_blank" rel="noopener noreferrer" aria-label="Twitter">
                <svg
                  ...
                  height="50"
                  viewBox="0 0 24 24"
                  className="fill-current border p-3 hover:fill-primary hover:border-primary transition-transform duration-300 ease-in-out hover:-translate-y-1"
                >
            ...
            <li>
              <a href="https://www.youtube.com/@teamstrike1st/videos" target="_blank" rel="noopener noreferrer" aria-label="YouTube">
                <svg
                  ...
                  height="50"
                  viewBox="0 0 24 24"
                  className="fill-current border p-3 hover:fill-accent hover:border-accent transition-transform duration-300 ease-in-out hover:-translate-y-1"
                >
            ...
            <li>
              <a href="https://www.facebook.com/teamstrike1st/" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                <svg
                  ...
                  height="50"
                  viewBox="0 0 24 24"
                  className="fill-current border p-3 hover:fill-secondary hover:border-secondary transition-transform duration-300 ease-in-out hover:-translate-y-1"
                >
            ...
            <li>
              <a href="https://www.instagram.com/teamstrike1st/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                <svg
                  ...
                  height="50"
                  fill="currentColor"
                  className="bi bi-instagram border p-3 hover:fill-accent hover:border-accent transition-transform duration-300 ease-in-out hover:-translate-y-1"
                  viewBox="0 0 16 16"
                >
            ...
            <li>
              <a href="https://www.twitch.tv/teamstrike1st" target="_blank" rel="noopener noreferrer" aria-label="Twitch">
                <svg
                  ...
                  height="50"
                  fill="currentColor"
                  className="bi bi-twitch border p-3 hover:fill-primary hover:border-primary transition-transform duration-300 ease-in-out hover:-translate-y-1"
                  viewBox="0 0 16 16"
                >
